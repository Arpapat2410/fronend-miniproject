            ...
            <>
                <form onSubmit={updateProduct}>
                    <div className="space-y-2">
                        ...
                        <div>
                            { !isLoading && ( <button className=" btn btn-success block w-full mt-6  text-white rounded-xl px-4 py-2 font-bold hover:bg-blue-600 hover:cursor-pointer">Update</button>)}         
                        </div>
                    </div>
                </form>
            </>
